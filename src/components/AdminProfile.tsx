...
const AdminProfile: React.FC = () => {
  ...
  const fetchProfile = async () => {
    try {
      ...
      setProfileError('Cannot load personal information. Please try again.')
    } finally {
  ...
  const handleProfileSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setProfileError('Cannot update personal information. Please try again.')
    } finally {
            ...
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="font-secondary text-gray-600 text-sm">
                  Manage your contact information and login account details.
                </p>
              </div>
            </div>
