...
const ConsultantNavigation: React.FC = () => {
  const navigate = useNavigate()
  const location = useLocation()
  const { logout } = useAuth()

  const navItems = [
    { path: '/consultant/dashboard', label: 'Tổng quan', icon: HomeIcon },
    { path: '/consultant/my-profile', label: 'Hồ Sơ Của Tôi', icon: UserCircleIcon }
  ]
